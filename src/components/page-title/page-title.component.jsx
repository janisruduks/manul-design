...
const PageTitle = ({image, title, para, link}) => {
    return (
        <div className='lg:grid lg:grid-cols-2 bg-c0/80 lg:mx-auto lg:max-w-screen-lg lg:border-3 p-3 rounded-lg shadow-black shadow-lg'>
