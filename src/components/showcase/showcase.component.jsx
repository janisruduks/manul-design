...
const Showcase = () => {
  return (
    <div className='mx-auto max-w-screen-lg'>
      <h1 className='uppercase text-center h-32 text-7xl text-transparent font-bold lg:px-32 bg-clip-text bg-gradient-to-r from-c1 to-gold'>
        Showcase</h1>
      <br/>
      <p className='text-white font-extrabold p-3 text-1xl'>
        - Some of the projects made
      </p>
      <div className='grid grid-cols-3 gap-5 border-4 border-c1 p-3'>
