...
const Footer = () => {
  return (
    <footer className="bg-c0/20 flex items-center justify-center rounded-md mt-10 m-2 font-mono lg:mx-auto lg:max-w-screen-sm lg:w-1/2">
      ...
      <div className="flex">
        <a href='https://janisruduks.space' className="px-2 py-2 rounded-md text-white hover:bg-white hover:text-c1 text-xs lg:text-sm">
